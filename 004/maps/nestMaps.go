...
func nestMapsTest(names []string, initial rune, name string) {
...
func nestMaps() {
	nestMapsTest(getNames(50), 'M', "Matthew")
	nestMapsTest(getNames(100), 'G', "George")
	nestMapsTest(getNames(150), 'D', "Drew")
	nestMapsTest(getNames(200), 'P', "Philip")
	nestMapsTest(getNames(250), 'B', "Bryant")
	nestMapsTest(getNames(300), 'M', "Matthew")
}
